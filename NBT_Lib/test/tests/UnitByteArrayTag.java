...
public class UnitByteArrayTag {

    private static Tag createTestTag() {
	return new ByteArrayTag("ByteArrayTag", new byte[0]);
    }
	...
	ByteArrayTag tag = (ByteArrayTag) createTestTag();
	...
	tag.accept(visitor);
	Assert.assertEquals(1, visitor.getVisitedByteArrayTagCount());
