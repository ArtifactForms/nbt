...
public class NbtChunk implements IChunk {
    ...
    public static NbtChunk createNbtChunk(int worldX, int worldZ) {
        ...
        root.add(
                new IntTag(
                        "DataVersion",
                        ClientVersion.VERSION_1_12_2.getDataVersion()
                )
        );
        root.add(new EndTag());
...
//	}
     ...
     * 
     * @param  x the x coordinate of the block (in chunk section coordinate
     *           space)
     * @param  y the y coordinate of the block (in chunk section coordinate
     *           space)
     * @param  z the z coordinate of the block (in chunk section coordinate
     *           space)
