...
public class UnitLongArrayTag {

    private static Tag createTestTag() {
        return new LongArrayTag("LongArrayTag", new long[0]);
    }
    ...
    public void getSetValue() {
        long[] newValue = new long[] { 1, 2, 3, 4, 5 };
        LongArrayTag tag = (LongArrayTag) createTestTag();
    ...
    public void acceptVisitor() {
        ...
        tag.accept(visitor);
        Assert.assertEquals(1, visitor.getVisitedLongArrayTagCount());
