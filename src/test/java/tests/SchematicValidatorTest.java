...
public class SchematicValidatorTest {
    ...
    public void heightLessThanZero() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.ONE_OR_MORE_VOLUME_ATTRIBUTES_ARE_LESS_THAN_ZERO,
                result.getCauses()[0]
        );
    }
    ...
    public void invalidRootNameCause() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.INVALID_ROOT_NAME, result.getCauses()[0]
        );
    }
    ...
    public void missingAttributeWidth() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.MISSING_REQUIRED_ATTRIBUTE_WIDTH,
                result.getCauses()[0]
        );
    }
    ...
    public void missingAttributeHeight() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.MISSING_REQUIRED_ATTRIBUTE_HEIGHT,
                result.getCauses()[0]
        );
    }
    ...
    public void missingAttributeLength() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.MISSING_REQUIRED_ATTRIBUTE_LENGTH,
                result.getCauses()[0]
        );
    }
    ...
    public void worldEditInfosAllShouldProvidedOriginX() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.IF_ONE_WORLD_EDIT_INFO_IS_PROVIDED_ALL_INFOS_SHOULD_BE_PROVIDED,
                result.getCauses()[0]
        );
    }
    ...
    public void widthTypeNotShortInt() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.TYPE_OF_WIDTH_IS_NOT_SHORT,
                result.getCauses()[0]
        );
    }
    ...
    public void heightTypeNotShortInt() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.TYPE_OF_HEIGHT_IS_NOT_SHORT,
                result.getCauses()[0]
        );
    }
    ...
    public void lengthTypeNotShortInt() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.TYPE_OF_LENTGH_IS_NOT_SHORT,
                result.getCauses()[0]
        );
    }
    ...
    public void missingAttributeBlocks() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.MISSING_REQUIRED_ATTRIBUTE_BLOCKS,
                result.getCauses()[0]
        );
    }
    ...
    public void typeOfBlocksIsNotByteArrayInt() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.TYPE_OF_BLOCKS_IS_NOT_BYTE_ARRAY,
                result.getCauses()[0]
        );
    }
    ...
    public void typeOfDataIsNotByteArrayInt() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.TYPE_OF_DATA_IS_NOT_BYTE_ARRAY,
                result.getCauses()[0]
        );
    }
    ...
    public void blocksSizeDoesNotMatchVolumeDesctiption() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.BLOCKS_SIZE_DOES_NOT_MATCH_VOLUME_DESCRIPTION,
                result.getCauses()[0]
        );
    }
    ...
    public void dataSizeDoesNotMatchVolumeDesctiption() {
        ...
        root.add(
                "Blocks",
                new byte[Short.MAX_VALUE * Short.MAX_VALUE * Short.MAX_VALUE]
        );
        root.add("Data", new byte[0]);
        root.add("Materials", "Alpha");
        root.addEnd();
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.DATA_SIZE_DOES_NOT_MATCH_VOLUME_DESCRIPTION,
                result.getCauses()[0]
        );
    }
    ...
    public void missingRequiredAttributeMaterials() {
        ...
        Assert.assertEquals(
                InvalidSchematicCauses.MISSING_REQUIRED_ATTRIBUTE_MATERIALS,
                result.getCauses()[0]
        );
    }
