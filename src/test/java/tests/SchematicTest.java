...
public class SchematicTest {
    ...
    private static Schematic loadTestSchematic() throws IOException {
        Schematic schematic = new Schematic(
                new File(TestUtil.TEST_FILES_PATH_READER + "bush.schematic")
        );
        return schematic;
    }
    ...
    public void createSchematicWithBlockCountGreaterThanMaxBlockCountThrowsException() {
        Schematic.createSchematic(
                Short.MAX_VALUE + 1, Short.MAX_VALUE, Short.MAX_VALUE
        );
    }
    ...
    public void getPlatformReturnsEmptyStringByDefault() {
        Schematic schematic = Schematic
                .createSchematic((short) 0, (short) 0, (short) 0);
    ...
    public void invalidRootNameThrowsException() throws IOException {
        String path = TestUtil.TEST_FILES_PATH
                + "schematic_invalid_root.schematic";
        new Schematic(new File(path));
    }
